...
$mcon=$_POST['mcon'];
$status=1;
$sql="INSERT INTO  tblstudents(StudentName,RollId,Gender,ClassId,DOB,bg,scholar,fname,fcon,mname,mcon,Status) VALUES(:studentname,:roolid,:gender,:classid,:dob,:bg,:scholar,:fname,:fcon,:mname,:mcon,:status)";
...
<div class="col-sm-10">
<input type="text" name="bg" class="form-control" id="fullanme" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="number" name="scholar" class="form-control" id="fullanme" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="fcon" class="form-control" id="fullanme" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="mname" class="form-control" id="fullanme" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="mcon" class="form-control" id="fullanme" required="required" autocomplete="off">
</div>
</div>
