...
$dob=$_POST['dob']; 
$bg=$_POST['bg'];
$scholar=$_POST['salary'];
$fcon=$_POST['contact'];
$status=1;
$sql="INSERT INTO  tblteacher(TeacherName,RollId,Gender,DOB,bg,salary,fcon,Status) VALUES(:studentname,:roolid,:gender,:dob,:bg,:scholar,:fcon,:status)";
...
<div class="col-sm-10">
<input type="number" name="salary" class="form-control" id="fullanme" required="required" autocomplete="off">
</div>
</div>
...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Teacher Contact No.</label>
<div class="col-sm-10">
<input type="text" name="contact" class="form-control" id="fullanme" required="required" autocomplete="off">
</div>
</div>
