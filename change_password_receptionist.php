...
$username="receptionist";
    $sql ="SELECT Password FROM reception_login WHERE UserName=:username and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update reception_login set Password=:newpassword where UserName=:username";
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Receptionist Change Password</h2>
                                </div>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li class="active">Receptionist Change Password</li>
            						</ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Receptionist_Changed Password </h5>
                                                </div>
                                            </div>
           <?php if($msg){?>
