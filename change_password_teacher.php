...
$username="teacher";
    $sql ="SELECT Password FROM teacher_login WHERE UserName=:username and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="update teacher_login set Password=:newpassword where UserName=:username";
...
<html lang="en">
    <head>
        ...
        <title>Teacher Changed Password</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Teacher Changed Password</h2>
                                </div>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
            							...
            							<li class="active">Teacher Changed Password</li>
            						</ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Teacher Changed Password</h5>
                                                </div>
                                            </div>
           <?php if($msg){?>
