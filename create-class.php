...
<html lang="en">
    <head>
        ...
        <title>Students class Creation</title>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form method="post">
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                			<input type="text" name="classname" class="form-control" required="required" placeholder="Class Name " id="success">
                                                       ...
                                                       <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            <input type="number" name="classnamenumeric" required="required" placeholder="Which class ? 1,2,3,4..." class="form-control" id="success">
                                                     ...
                                                     <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            <input type="text" name="section" class="form-control" required="required" placeholder="Section A,B,C..." id="success">
