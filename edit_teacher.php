...
$status=$_POST['status'];
$sql="update tblteacher set TeacherName=:studentname,RollId=:roolid,Gender=:gender,DOB=:dob,bg=:bg,salary=:salary,fcon=:fcon,Status=:status where id=:stid ";
  ...
  <?php include('../includes/teacher_topbar.php');?> 
            ...
            <div class="content-wrapper">
                <div class="content-container">
                    ...
                    <!-- ========== LEFT SIDEBAR ========== -->
                   <?php include('../includes/teacher_leftbar.php');?>  
                    <!-- /.left-sidebar -->
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Update Teacher Info </h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Update Teacher Info </li>
                                    </ul>
                                </div>
...
$sql = "SELECT tblteacher.TeacherName,tblteacher.RollId,tblteacher.Gender,tblteacher.DOB,tblteacher.bg,tblteacher.salary,tblteacher.fcon,tblteacher.Status from tblteacher where tblteacher.id=:stid";
$query = $dbh->prepare($sql);
$query->bindParam(':stid',$stid,PDO::PARAM_STR);
$query->execute();
...
<div class="col-sm-10">
<input type="text" name="fullanme" class="form-control" id="fullanme" value="<?php echo htmlentities($result->TeacherName)?>" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="text" name="rollid" class="form-control" id="rollid" value="<?php echo htmlentities($result->RollId)?>" maxlength="20" required="required" autocomplete="off">
</div>
</div>
...
<div class="col-sm-10">
<input type="number" name="salary" class="form-control" id="fullanme" value="<?php echo htmlentities($result->salary)?>" required="required" autocomplete="off">
</div>
</div>
...
<div class="form-group">
<label for="default" class="col-sm-2 control-label">Teacher contact </label>
<div class="col-sm-10">
