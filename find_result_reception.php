                            ...
                            <div class="panel-body p-20">
                                ...
                                <form action="result.php" method="post">
                                	<div class="form-group">
                                		<label for="rollid">Enter Students Roll ID</label>
...
<?php }} ?>
                                    ...
                                    <div class="form-group mt-20">
                                       ...
                                       <div class="col-sm-6">
                                                               <a href="reception_access.php">Back to Home</a>
                                                            </div>
                                </form>
                        ...
                        <!-- /.panel -->
                        <p class="text-muted text-center"><small>Copyright © <a href="http://www.iubat.edu/">IUBAT_Quad_Core</a> 2017</small></p>
                    </div>
