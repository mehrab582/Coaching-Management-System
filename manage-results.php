...
echo htmlentities('Active');
   ...
   echo htmlentities('Blocked'); 
                                                                ...
                                                                ?></td>
<td>
<button><a href="edit-result.php?stid=<?php echo htmlentities($result->StudentId);?>"><i  title="Edit Record">EDIT</i>  </a></button>
<button><a href="delete_result.php?stid=<?php echo htmlentities($result->StudentId);?>"><i  title="Edit Record">DELETE</i> </a> </button>
</td>
</tr>
<?php $cnt=$cnt+1;}} ?>
