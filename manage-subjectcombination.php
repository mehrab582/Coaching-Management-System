...
<?php if($stts=='0')
{ ?>
<a href="manage-subjectcombination.php?acid=<?php echo htmlentities($result->scid);?>" onclick="confirm('do you really want to activate this subject');"><i  title="Acticvate Record">Activate</i> </a><?php } else {?>

<a href="manage-subjectcombination.php?did=<?php echo htmlentities($result->scid);?>" onclick="confirm('do you really want to deactivate this subject');"><i  title="Deactivate Record">Deactivate</i></a>
<?php }?>
</td>
</tr>
<?php $cnt=$cnt+1;}} ?>
